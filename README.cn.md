...
- **上游仓库**: <https://github.com/achristmascarl/rainfrog>
- **官网**: <https://crates.io/crates/rainfrog>
- **许可证**: MIT
...
- **Star**: 5,325 · **Fork**: 95 · **开放 issue**: 98 · **贡献者**: 18

## 累计统计

- **发布数**: 61 · **已合并 PR**: 235 · **开放 PR**: 1 · **已关闭 issue**: 85 · **开放 issue**: 13 · **提交数**: 351

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 2 | 14 | 0 | 1 | 0 | 14 |
| last60d | 2026-07-13 | 5 | 28 | 0 | 2 | 1 | 28 |
| 90d | 2026-06-13 | 7 | 38 | 1 | 3 | 1 | 38 |
| last180d | 2026-03-15 | 8 | 48 | 1 | 11 | 2 | 48 |
| 360d | 2025-09-16 | 18 | 91 | 1 | 28 | 5 | 93 |
| last720d | 2024-09-21 | 39 | 168 | 1 | 63 | 10 | 186 |
...
在 [repology.org](https://repology.org/project/rainfrog) 上共有 **16** 个发行版报告此项目。**10** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。
...
rainfrog 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `rainfrog` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/rainfrog.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T20:52:39Z._
